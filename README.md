...
一套复刻 Apple Liquid Glass 质感的 React 组件库:42 个组件共享同一种会折射的玻璃材质、同一套主题与无障碍标准。**English speakers:** a React component library that recreates Apple's Liquid Glass — real edge refraction on Chromium, a graceful frosted fallback everywhere else.
