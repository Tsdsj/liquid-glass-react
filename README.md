...
66 个组件，分成两层——这个分层本身就是这套设计的核心：

| 层 | 组件 |
| --- | --- |
| **内容**（实色，不透明） | Text、Card、Concentric、GroupBox、List、OutlineView、MaterialView、Divider、Kbd、DisclosureGroup |
...
```text
74 单元 · 7 SSR · 425 真实 Google Chrome · 13 开发模式 · 18 WebKit + Firefox
```
