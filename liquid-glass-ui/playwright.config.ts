...
export default defineConfig({
  ...
  webServer: process.env.TEST_URL ? undefined : { command: 'node scripts/serve-preview.mjs --root apps/playground/dist', port: 4173, reuseExistingServer: !process.env.CI, timeout: 10_000 },
});
