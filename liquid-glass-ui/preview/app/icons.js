...
export function Icon({ name, size = 20, style }) {
    return _jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: name === 'more' ? 3.5 : 1.65, strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", focusable: "false", style: style, children: _jsx("path", { d: paths[name] ?? paths.layer }) });
}
