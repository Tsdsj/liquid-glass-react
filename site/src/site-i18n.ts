...
export const SITE_COPY = {
  ...
  componentsSubtitle: {
    'zh-CN': '25 个玻璃组件,覆盖通用控件、数据录入、选择导航、容器展示与浮层反馈。',
    'en-US': '25 glass components across general controls, data entry, selection/navigation, containers/display and overlay feedback.',
  },
