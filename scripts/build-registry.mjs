...
/** Sources are nested by layer (system / content / controls / fields / navigation / overlays), so walk the tree. */
...
const manifest={schema:'liquid-glass-ui/local-source-registry/v1',version,license:'MIT',note:'Local source-copy manifest. NOT a shadcn registry and NOT a published service.',items};
